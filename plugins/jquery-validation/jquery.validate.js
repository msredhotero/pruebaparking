...
$.extend( $.validator, {
	...
	messages: {
		...
		dateISO: "Por favor ingrese un (ISO) valido.",
		...
		min: $.validator.format( "Por favor ingrese valores mayores a {0}." ),
		step: $.validator.format( "Por favor ingrese multiplos de {0}." )
	},
