...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../platos/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Platos",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
$eliminar = "eliminarPlatos";

$insertar = "insertarPlatos";
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=platos",
			"language": {
