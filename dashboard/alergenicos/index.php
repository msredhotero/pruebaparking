...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../alergenicos/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Alergenicos",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
$eliminar = "eliminarAlergenicos";

$insertar = "insertarAlergenicos";
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=alergenicos",
			"language": {
