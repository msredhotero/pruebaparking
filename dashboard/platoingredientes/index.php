...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../platoingredientes/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Plato Ingredientes",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Plato Ingrediente";

$plural = "Plato Ingredientes";

$eliminar = "eliminarPlatosingredientes";

$insertar = "insertarPlatosingredientes";
...
$existeI = $serviciosReferencias->existe('select idingrediente from tbingredientes');
$existeA = $serviciosReferencias->existe('select idplato from dbplatos');
								...
								<div class="row">
									<div class="col-lg-12 col-md-12">
										<div class="button-demo">
											<button <?php if (($existeI == 0) && ($existeA == 0)) { echo 'disabled="disabled"'; }?> type="button" class="btn bg-light-green waves-effect btnNuevo" data-toggle="modal" data-target="#lgmNuevo">
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=platoingredientes",
			"language": {
