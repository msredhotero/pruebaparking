...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../ingredientes/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Ingredientes",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
$eliminar = "eliminarIngredientes";

$insertar = "insertarIngredientes";
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=ingredientes",
			"language": {
