...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../ingredientealergenicos/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Ingrediente Alergenicos",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Ingrediente Alergenico";

$plural = "Ingrediente Alergenicos";

$eliminar = "eliminarIngredientesalergenicos";

$insertar = "insertarIngredientesalergenicos";
...
$tabla 			= "dbingredientesalergenicos";
...
$existeA = $serviciosReferencias->existe('select idalergenico from tbalergenicos');
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=ingredientesalergenicos",
			"language": {
